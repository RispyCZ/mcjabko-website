    ...
    <>
      <Layout>
        ...
        <div className={styles.top}>
          <h1>Pravidla</h1>
          <h2>
            Pravidla jsou velice důležitá pro klidně hraní. Pokud je však
            porušíš trest tě nemine.
          </h2>
        </div>

        <div className={styles.content_wrapper}>
          <p>
            Jelikož chceme na našem serveru udržovat férovou a příjemnou hru
            všem hráčům, je důležité dodržovat závazná pravidla!
          </p>
          <h3>
          ...
          <ol>
            ...
            <li>
              ...
              válečné zločiny a jakékoliv protiprávní jednání v rámci zákonů
            ...
            <li>
              Je zakázáno jakkoli žádat o věci či jiné výhody členy A-teamu (
              tj. fly, creative, OP aj.)!
            </li>
            <li>
            ...
            <li>
              Je zakázáno využívat veškerých bugů (a podobné jako clay bug)!
              Hráč je povinen takový bug bezodkladně nahlásit členovi A-teamu!
            </li>
            <li>
              ...
              velkými farmami atd.! Třídičky nesmí překročit 10 třídících členů
              na chunk!
            </li>
            <li>
            ...
            <li>
              Každý hráč má povinnost nahlásit hráče porušujícího pravidla!
            </li>
            <li>Nabádání jiných hráčů k porušování pravidel je zakázáno!</li>
            <li>
              Je zakázáno jakkoli propagovat, tvořit reklamu, nabádat a
              doporučovat jiné minecraft servery, discord servery, nebo
              jakékoliv jiné produkty prostřednictvím serveru, či discord
              serveru.
            </li>
            <li>
            ...
            <li>
              ...
              hry, podvádění (jakýmikoliv způsobem) a griefing, vymazat inventář
              a zabavit veškerý majtek.
            </li>
            <ol>
              <li>
          ...
          <ol>
            <li>
              Griefing, to znamená, ničení, stavba a jiné narušování staveb
              cizích hráčů bez povolení je přísně zakázán!
            </li>
            <li>Je zakázáno jakkoliv ničit hlavní ostrov v endu!</li>
            <li>Je zakázáno stavět jakékoliv farmy v endu!</li>
            <li>
              Je zakázáno narušovat ráz krajiny nesmyslnými stavbami, tj.
              sloupy, plošinami, létajícími stromy a jakékoliv jiné narušování!
            </li>
            <li>
              Je zakázáno zabíjet hráče v zájmu získání jejich věcí. Toto
              neplatí pouze v PvP aréně!
            </li>
            <li>
              Pokud dva hráči dospějí k dohodě, kdy si po vzájemném souboji v
              PvP aréně vrátí věci a jedna ze stran tuto dohodu poruší, jedná se
              o krádež a bude tak i trestána dle platných pravidel!
            </li>
            <ol>
              <li>
          ...
          <ol>
            <li>
              Griefing mimo Raid, je zakázán. 1.2 Raid lze uskutečnit jen pokud,
              je alespoň jeden z majitelů stavby přítomen. Zároveň musí majitel
              souhlasit s možností raidů v rámci jejich RP.
            </li>
            <li>
              PvP je obecně povoleno, je však zakázáno cíleně, nebo opakovaně
              zabíjet jednoho hráče, nebo skupinu, pouze z důvodu získání jeho
              věcí. 2.2 Pokud byl hráč zabit v rámci RP, nesmí se vracet do
              okolí své smrti po dobu 15 minut. 2.3 Vyjímkou je respawn v
              posteli, ve svém domě.
            </li>
            <li>
              Je zakázáno bránit přístupu jakémukoliv hráči v okruhu 1000 bloků
              od spawnu.
            </li>
            <li>Je zakázáno zabíjet hráče v okruhu 1000 bloků od spawnu!</li>
            <li>
              Hráči mají možnost si vytvářet svá pravidla mimo zemí 1000 bloků
              od spawnu a vymáhat je i pod hrozbou zabití. 5.2 Tyto pravidla
              musí být však jasně poskytnuty ostatním hráčům.
            </li>
          </ol>
          ...
          <ol>
            <li>
              Platí zde všechna pravidla z bodu B. až na následující vyjímky.
            </li>
            <li>Je zakázáno se odpojovat během souboje.</li>
            <ol>
              <li>
                Griefing a zabijení hráčů pro získaní jejich věcí je povolen.
              </li>
              <li>Hráč nemá práva na žádnou plochu kolem jeho domu.</li>
            </ol>
            <li>
              Je zakázáno farmit srdíčka na svých alt účetech nebo ostatních
              hráčích.
            </li>
            <ol>
          ...
          <ol>
            <li>
              ...
              totem of undying a jakékoliv efekty uvnitř arény(to znamená i
              notch a golden apples)!
            </li>
            <li>
